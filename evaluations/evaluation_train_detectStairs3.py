...
from Methodes.detectStairs3 import detect_stairs_with_homography, find_optimal_canny_threshold, rotate_image, detect_stairs


def update_json_with_predictions(train_dir, json_file, output_file):
    """
    Parcourt le dossier train, applique detect_stairs3(), et met à jour gt.json avec les résultats.
...
updated_json = "gt_result_train_detectStairs3.json"
