...
from Methodes.detectStairs4 import detect_stairs_with_homography

def update_json_with_predictions(train_dir, json_file, output_file):
    """
    Parcourt le dossier train, applique detect_stairs4(), et met à jour gt.json avec les résultats.
...
updated_json = "gt_result_train_detectStairs4.json"
