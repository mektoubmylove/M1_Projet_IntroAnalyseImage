...
from Methodes.findContoursRectangle1 import detect_stairs_rectangles


def update_json_with_predictions(train_dir, json_file, output_file):
    """
    Parcourt le dossier train, applique detect_stairs_rectangles(), et met à jour gt.json avec les résultats.
...
updated_json = "gt_result_train_findCountoursRectangle1.json"
