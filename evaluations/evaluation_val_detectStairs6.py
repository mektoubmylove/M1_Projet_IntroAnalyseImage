...
from Methodes.detectStairs6 import detect_stairs_with_homography

def update_json_with_predictions(train_dir, json_file, output_file):
    """
    Parcourt le dossier val, applique detect_stairs6(), et met à jour gt.json avec les résultats.
...
updated_json = "gt_result_val_detectStairs6.json"
